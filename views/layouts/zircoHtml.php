                            ...
                            <ul class="list-unstyled topnav-menu float-right mb-0">
                                ...
                                <li class="dropdown d-none d-lg-block">
                                    <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                        <img src="/zirco/dist/assets/images/flags/us.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <img src="/zirco/dist/assets/images/flags/germany.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">German</span>
                                        </a>
    
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <img src="/zirco/dist/assets/images/flags/italy.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Italian</span>
                                        </a>
    
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <img src="/zirco/dist/assets/images/flags/spain.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Spanish</span>
                                        </a>
    
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <img src="/zirco/dist/assets/images/flags/russia.jpg" alt="user-image" class="mr-2" height="12"> <span class="align-middle">Russian</span>
                                        </a>
                                    </div>
                                </li>
                                                ...
                                                <div class="inbox-widget">
                                                        <a href="#">
                                                            <div class="inbox-item">
                                                                <div class="inbox-item-img"><img src="/zirco/dist/assets/images/users/avatar-1.jpg" class="rounded-circle" alt=""></div>
                                                        ...
                                                        <a href="#">
                                                            <div class="inbox-item">
                                                                <div class="inbox-item-img"><img src="/zirco/dist/assets/images/users/avatar-2.jpg" class="rounded-circle" alt=""></div>
                                                        ...
                                                        <a href="#">
                                                            <div class="inbox-item">
                                                                <div class="inbox-item-img"><img src="/zirco/dist/assets/images/users/avatar-3.jpg" class="rounded-circle" alt=""></div>
                                                        ...
                                                        <a href="#">
                                                            <div class="inbox-item">
                                                                <div class="inbox-item-img"><img src="/zirco/dist/assets/images/users/avatar-4.jpg" class="rounded-circle" alt=""></div>
                                                        ...
                                                        <a href="#">
                                                            <div class="inbox-item">
                                                                <div class="inbox-item-img"><img src="/zirco/dist/assets/images/users/avatar-5.jpg" class="rounded-circle" alt=""></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        <img src="/zirco/dist/assets/images/users/avatar-1.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="/zirco/dist/assets/images/users/avatar-2.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="/zirco/dist/assets/images/users/avatar-3.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="/zirco/dist/assets/images/users/avatar-4.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <img src="/zirco/dist/assets/images/users/avatar-5.jpg" alt="user" class="avatar-sm rounded-circle" />
                                                    </th>
                                                    <td>
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="p-4">
                    ...
                    <div class="mb-2">
                        <img src="/zirco/dist/assets/images/layouts/light.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="/zirco/dist/assets/images/layouts/dark.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="/zirco/dist/assets/css/bootstrap-dark.min.css" 
                            data-appStyle="/zirco/dist/assets/css/app-dark.min.css" />
                        <label class="custom-control-label" for="dark-mode-switch">Dark Mode</label>
                    </div>
            
                    <div class="mb-2">
                        <img src="/zirco/dist/assets/images/layouts/rtl.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appStyle="/zirco/dist/assets/css/app-rtl.min.css" />
                        <label class="custom-control-label" for="rtl-mode-switch">RTL Mode</label>
                    </div>

                    <div class="mb-2">
                        <img src="/zirco/dist/assets/images/layouts/dark-rtl.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-5">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-rtl-mode-switch" data-bsStyle="/zirco/dist/assets/css/bootstrap-dark.min.css" 
                            data-appStyle="/zirco/dist/assets/css/app-dark-rtl.min.css" />
